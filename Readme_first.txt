...
If your response variable ranges from 0 to 1000 for example, the easiest way would be to normalize it by dividing with the maximum value observed and run HABFUZZ or,
