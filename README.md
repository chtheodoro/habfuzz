...
a. Including the option for a fourth fuzzy input and  
b. Including the option to bypass the cross-validation process and start directly by predicting the response variable in the test dataset. 
